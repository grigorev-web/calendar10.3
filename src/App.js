...
function App() {
  ...
  function handleSelectType(event) {
    addParamToURL("type", event.value);
    setState((prevState) => ({
      ...prevState,
      showEvents: 10,
      select: {
  ...
  function handleSelectPeriod(event) {
    ...
    addParamToURL("period", event.value);
    switch (event.value) {
      ////////////////////////
      case "all-period":
  ...
  //console.log(state);
  if (!(dayD === 1 || dayD === 2 || dayD === 3 || dayD === 4)) {
  ...
  //console.log(state);
  const selectType = [
    { value: "all-events", label: "Все мероприятия" },
    { value: "russoft-events", label: "Мероприятия РУССОФТ" },
    { value: "partners-events", label: "Мероприятия партнеров" },
    { value: "company-events", label: "Мероприятия компаний" }
  ];

  const selectPeriod = [
    { value: "all-period", label: "За все время" },
    { value: "next-week", label: "На неделю вперед" },
    { value: "next-month", label: "На месяц вперед" },
    { value: "next-half-year", label: "На полгода вперед" },
    { value: "next-year", label: "На год вперед" },

    { value: "last-week", label: "За прошлую неделю" },
    { value: "last-month", label: "За прошлый месяц" },
    { value: "last-half-year", label: "За прошлые полгода" },
    { value: "last-year", label: "За прошлый год" }
  ];
    ...
    <div>
      ...
      <div className="DayPicker-filter">
        <div className="DayPicker-filter__select">
          <Select
            defaultValue={{ label: "Все мероприятия", value: "all-events" }}
            options={selectType}
            isSearchable={false}
          ...
          <Select
            defaultValue={{ label: "На месяц вперед", value: "next-month" }}
